...
// SVG viewBox is 0 0 385 128. The X mark spans 0–167, ebia spans 133–384.
const LOGO_W = 576; // rendered width (1.5× the 385px SVG)
const LOGO_H = 192; // rendered height
...
export const LogoStinger: React.FC<Props> = ({ tagline }) => {
  ...
  // X mark: scales from its centroid (83.5, 64) in SVG units
  ...
  // ebia: clip-rect grows from x=133 to x=384 (width 0 → 251 SVG units)
