...
export const SplitLayout: React.FC<Props> = ({ left, right }) => {
  ...
  // Left text mask reveal (after panel arrives, ~frame 22)
  ...
  // Right text mask reveal (delayed 8 more frames)
  ...
  return (
    <AbsoluteFill style={{ flexDirection: "row" }}>
      {/* Left panel — clips content sliding from left */}
      ...
      {/* Right panel — clips content sliding from right */}
      <div style={{ flex: 1, overflow: "hidden" }}>
        <div style={{
          width: "100%", height: "100%",
